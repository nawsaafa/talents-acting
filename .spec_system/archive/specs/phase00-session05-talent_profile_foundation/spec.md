...
- Video upload (showreel, presentation) - _Reason: Requires video hosting solution_
- Advanced 40+ category filters - _Reason: Phase 01 feature_
- Search/discovery features - _Reason: Phase 01 feature_
- Profile image cropping/editing - _Reason: Polish, not MVP_
- Multiple photos/gallery - _Reason: MVP uses single headshot_
