...
const registrationTypes = [
  {
    title: 'Talent',
    description:
      'Actors, comedians, and performers looking to showcase their profiles and connect with industry professionals.',
  ...
  },
  {
    title: 'Professional',
    description:
      'Casting directors, film directors, producers, and other film industry professionals seeking talent.',
  ...
  },
  {
    title: 'Company',
    description:
      'Production companies, talent agencies, and organizations looking to access our talent database.',
