...
export const metadata: Metadata = {
  ...
  description: 'Your professional registration has been submitted',
};
      ...
      <div className="mx-auto max-w-lg px-4 sm:px-6 lg:px-8">
        <div className="rounded-lg border border-zinc-200 bg-white p-8 text-center shadow-sm">
          ...
          <p className="mt-4 text-zinc-600">
            Thank you for registering as a professional on Talents Acting.
          </p>
          ...
          <div className="mt-8 rounded-lg bg-blue-50 p-4 text-left">
            ...
            <ol className="mt-2 list-inside list-decimal space-y-2 text-sm text-blue-800">
              ...
              <li>
                <strong>Wait for approval</strong> - Our team will review your application and
