        ...
        <Card>
          <CardBody className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">
              Talent profiles are only available for users registered as
              talents.
            </p>
            <Link href="/">
          ...
          <CardBody>
            <div className="flex flex-col sm:flex-row gap-6">
              ...
              <div className="flex-1">
                ...
                {/* Skills Preview */}
                {profile.performanceSkills &&
                  profile.performanceSkills.length > 0 && (
                    <div className="mt-4">
            ...
            <div className="mt-6 pt-6 border-t">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span
                    className={
                      profile.isPublic ? "text-green-600" : "text-gray-500"
                    }
                  >
